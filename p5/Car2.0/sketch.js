...
function setup() {
  ...
  function drawCar(positionX, positionY, width, height, color) {
    fill('black');
    rect(positionX + 13, positionY + 22, width-18, height- 15);rect(positionX + 13, positionY + 43, width-18, height- 15);
    rect(positionX + 33, positionY + 22, width-18, height- 15);
    rect(positionX + 33, positionY + 43, width-18, height- 15);
    fill(color);
    rect(positionX + 10, positionY + 25, width + 13, height);
  ...
  function drawLane(x, y, w, h, direction, c) {
    ...
    tint(155, 155);
    rect(x, y, w, h);
    drawCar(x +50, y, 30, 20, "green");
    drawCar(x + 175, y, 30, 20, "red");
    drawCar(x + 300, y, 30, 20, "purple");
    drawCar(x + 425, y, 30, 20, "blue");
